...
- [Deposit TX](https://stellar.expert/explorer/testnet/tx/efb628d6e09978257c35ff75cba10a3080c0142de00889c4d01d42009ee152f2) — Owner deposited 50 USDC via the vault `deposit` entrypoint; `get_contribution(owner, period)` records it toward the 100 USDC monthly target (Aug 22, 2026)
- [Request With Receipt TX](https://stellar.expert/explorer/testnet/tx/0b026ab8841c78e2c0732ca2d184c4ed9809fb4baafab4af225251d11002c515) — request #1 for 150 USDC (Repairs, under the 300/month cap) submitted with a persisted `receipt_url` (Aug 22, 2026)
- [On-chain Comments TX](https://stellar.expert/explorer/testnet/tx/bf479eae9937ce833f20dd7ba626705f4ee47f620143c251f2cdbd1e75797a26) — two members discussed request #1 via `add_comment` (`comment_added` events); thread readable via `get_comments` ([second member TX](https://stellar.expert/explorer/testnet/tx/6a68e88911342db294edfab50730df932fa5dacebf9252debd341c50cf42c8b3)) (Aug 22, 2026)
- [Approve & Execute TXs](https://stellar.expert/explorer/testnet/tx/e705267c2e31892b6d5fb22e14c20282a0adb84095d7afaaccb82430d0f56a22) — Owner approved request #1 ([execute TX](https://stellar.expert/explorer/testnet/tx/c3a2f5ebbb3e14fa5bc51ccfa1ab528bb0de49a539ee16a05390a0774a42736e)); vault paid the 150 USDC recipient on-chain and the request status moved to Executed (Aug 22, 2026)
